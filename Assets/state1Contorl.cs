...
public class state1Contorl : MonoBehaviour
{
    ...
    string[] text = { "สวัสดีครับ ผมชื่อแซม ", "วันนี้ผมจะมาแนะนำให้คุณรู้จักวิธีการเก็บข้อมูลแบบ Blockchain"
            ...
            ,"นั่นไง! ข้อมูลที่คุณใส่ถูกบันทึกลงไปแล้ว และจะถูกเข้ารหัสเรียกว่า hash","โดยทุกครั้งที่เราบันทึกข้อมูล ข้อมูลและการเข้ารหัสจะถูกเก็บไว้รวมกันเรียกว่า 1 Block","ลองใส่ข้อมูลอีก 2 ครั้ง แล้วสังเกตการเปลี่ยนแปลงสิ"
            , "ในการเข้ารหัส Hash นั้น จะเอาทุกอย่างใน block มาคำนวณ","แต่การเข้ารหัสจริงๆแล้วยังมีส่วนอื่นๆอีกไปดูกันเลย", "" };
    string[] missionText = { "ลองกรอกข้อมูลดูสิ!(กรอกเป็นตัวเลข)", "ลองกรอกข้อมูลอีก 2 ครั้ง" };
