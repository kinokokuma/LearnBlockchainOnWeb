...
public class state3Contorl : MonoBehaviour
{
    ...
    string[] text = { "ครั้งนี้ผมจะยังไม่เฉลยแล้วกันแต่จะให้คุณลองเปลี่ยนข้อมูลใน Block ตรงกลาง", "ให้ทำการคลิ๊กที่ Block แล้วกรอกตัวเลขได้เลย"
            ,"เพื่อให้ง่ายผมจะช่วยคำนวณ Hash และสุ่ม Nonce ให้แล้วกัน", "อย่าลิมสังเกตความเปลี่ยนแปลงหลังกรอกตัวเลขด้วยนะ"
            , "เห็นมั้ยว่าพอ Hash ของ Block ที่ 2 เปลี่ยน ก็ทำให้ hash ของ Blockถัดมาเปลี่ยนด้วย", "เพราะว่าการคำนวณ hash จะนำ Hash ของ Block ก่อนหน้ามาคำนวณด้วย"
