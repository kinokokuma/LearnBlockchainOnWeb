...
public class State4Contorl : MonoBehaviour
{
    ...
    public getText[] data1, data2, data3;
      string[] text = { "เรามาดูกันดีกว่า ว่าการเก็บข้อมูลแบบที่ไม่ใช้ Blockchain เป็นอย่างไร", "ยกตัวอย่างธนาคาร การที่เราฝากเงินในธนาคารนั้น ธนาคารจะทำการจดบันทึกข้อมูลไว้เพียงผู้เดียว"
            , "ซึ่ง ถ้าธนาคารจดผิด หรือแอบเปลี่ยนข้อมูลเราก็ไม่สามารถโต้แย้งได้เพราะเราไม่ใช่คนจดข้อมูล", "แต่ Blockchain เวลามีการบันทึกข้อมูล จะบอกให้ทุกคนรู้ และทุกคนจะจดข้อมูล"
            , "แล้วทุกคนจะทำการจดข้อมูลของตนเอง และทำการตรวจสอบซึ่งกันและกัน", "ถ้าไม่เชื่อก็ลองไปแก้ข้อมูลในตารางแรกดูสิ" , "เห็นไหมว่าblock กลายเป็นสีแดง แสดงว่าระบบไม่ยอมรับ จริงๆมันก็สามารถแก้ได้นะ แต่เราต้องทำให้ข้อมูลส่วนใหญ่เหมือนกับเรา"
    ...
    string[] missionText = { "เปลี่ยนข้อมูล Block ที่ 2 ของตารางแรก","แก้ข้อมูลตารางที่ 2 ให้เหมือนตารางแรก","ที่ตารางสุดท้ายกลายเป็นสีแดงเพราะข้อมูลไม่เหมือนกับคนส่วนใหญ่ระบบจึงไม่ยอมรับ"};
